...
// [PROCESSOR]: process each row from MatchInput type to Match type 
public class MatchDataProcessor implements ItemProcessor<MatchInput, Match> { // ItemProcessor<Input, Output>
